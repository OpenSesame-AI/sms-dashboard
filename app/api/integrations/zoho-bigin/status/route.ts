  ...
  try {
    ...
    if (!integration) {
      ...
      try {
        if (composio) {
          ...
          // Check for Zoho Bigin connections
        ...
        console.error('[Zoho Bigin Status] Error checking Composio connections:', composioError)
      }
    ...
    if (connectionId) {
      try {
        ...
        console.error('[Zoho Bigin Status] Error fetching connection:', error)
        return NextResponse.json({
          connected: false,
          syncedContactsCount: integration.syncedContactsCount || 0,
    ...
    console.error('[Zoho Bigin Status] Unexpected error:', error)
    return NextResponse.json(
      { 
